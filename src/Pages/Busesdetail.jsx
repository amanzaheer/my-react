...
export default function Busesdetail() {
  return (
    <Layout>
      <Topboxes />
      ...
      <div className="space-y-6 p-4">
        ...
        <div className="flex flex-wrap justify-between items-center">
          <div className="flex items-center gap-2">
            <h1 className="text-2xl font-bold">RBCTWF-BUS</h1>
        ...
        <div className="bg-white shadow rounded-2xl p-6">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-y-4 text-sm">
            ...
            <div>
              ...
              <p className="text-black">#RBCTWF-BUS</p>
            </div>
            <div>
            ...
            <div>
              ...
              <p className="text-black">+92 311 9876543</p>
            </div>
          </div>
        </div>
            ...
            <div className="flex-1 flex flex-col gap-6">
              ...
              <div className="bg-white shadow rounded-2xl p-6 w-full">
                ...
                <div className="flex justify-between text-sm mb-2">
                  <span className="font-semibold">Bus Ticket(s)</span>

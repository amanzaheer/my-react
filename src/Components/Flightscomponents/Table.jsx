              ...
              {rows.map((row, i) => (
                <tr key={row.id} className="border-b border-gray-200 hover:bg-gray-50">
                  ...
                  {row.data.map((cell, cIndex) => {
                    ...
                    // Reference# → black text, no underline
                    if (header === "Reference#") {
                      return (
                        <td key={cIndex} className="p-3 text-black">
                          <Link to={`/flightsdetail/${row.id}`}>{cell}</Link>
                        </td>
                      );
                    }
                    ...
                    // Action column: edit icon + dropdown
                    if (header === "Action") {
                      return (
                        <td key={cIndex} className="p-3 relative">
                          <button

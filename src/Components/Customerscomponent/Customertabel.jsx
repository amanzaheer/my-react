...
export default function Customertabel() {
  ...
  return (
    <div className="p-1">
      ...
      {/* Main Card Container */}
      <div className="bg-white rounded-lg shadow-2xl w-full max-w-none p-6">
        {/* Top Section */}
          ...
          <div className="flex gap-3 items-center">
            <div className="relative">
              <input 
                ...
                className="w-72 px-3 py-2 pr-8 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 text-base bg-gray-100"
              />
        ...
        <div className="relative">
          <table className="w-full">
            <thead className="bg-gray-50">
              <tr>
                <th className="px-2 py-3 text-left text-sm font-semibold text-gray-500">
                ...
                <tr key={customer.id} className="border-b border-gray-200 hover:bg-gray-50">
                  <td className="px-6 py-4">
                    <div className="flex items-center gap-2">
                      ...
                      />
                      <span className="text-xl text-gray-800 whitespace-nowrap">{customer.date}</span>
                    </div>
                  </td>
                  <td className="px-2 py-3 text-xl text-gray-800 whitespace-nowrap">{customer.website}</td>
                  <td className="px-2 py-3 text-xl text-gray-800">
                    <div className="flex items-center gap-2">
                      <img 
                  ...
                  <td className="px-2 py-3 text-xl text-gray-800 whitespace-nowrap">{customer.country}</td>
                  <td className="px-2 py-3 text-xl text-gray-800 whitespace-nowrap">{customer.phone}</td>
                  <td className="px-2 py-3 text-xl text-gray-800 whitespace-nowrap">{customer.email}</td>
                    ...
                    {showDropdown === customer.id && (
                      <div className="absolute right-0 top-full mt-1 w-40 bg-white border border-gray-200 rounded-lg shadow-lg z-10">
                        ...
                        <button 
                          ...
                          className="w-full px-4 py-3 text-left text-base text-gray-600 hover:bg-gray-50 flex items-center gap-3 transition-colors duration-200"
                        >
                          <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
